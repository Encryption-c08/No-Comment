...
SETTINGS_GROUPS: List[SettingGroup] = [
    SettingGroup(
        key="general",
        label="General",
        description="Global NoComment preferences.",
        options=[
            SettingOption(
                key="language",
                label="Language",
                option_type="select",
                description="Choose the language used by NoComment.",
                default="en",
            ...
            SettingOption(
                ...
                label="Donate Keys",
                option_type="toggle",
                description="Allow NoComment to donate spare Steam keys. (placeholder option)",
                default=True,
    ...
    SettingGroup(
        key="addViaNoComment",
        label="Add via NoComment",
        description="Control what gets installed when adding a game via NoComment.",
        options=[
            SettingOption(
