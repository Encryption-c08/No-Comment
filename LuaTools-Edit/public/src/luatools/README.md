# LuaTools Frontend Source Layout

This folder contains the editable source split for the LuaTools frontend.

Build output:
- `public/modules/luatools.app.js` (generated runtime file loaded by bootstrap)
